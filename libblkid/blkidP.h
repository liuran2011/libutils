...
char *blkid_strndup(const char *s, const int length);
...
void blkid__scan_dir(char *, dev_t, struct dir_list **, char **);
...
void blkid_probe_set_wiper(blkid_probe pr, blkid_loff_t off,
				  blkid_loff_t size);
